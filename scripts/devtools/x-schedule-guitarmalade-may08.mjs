...
const TARGET_DAY = { year: 2026, month: 5, day: 8 };
  ...
  return [
    {
      ...
      caption:
        "Chord spelling is where theory starts making sense. Learn how chords are built so you can hear it, see it, and use it on the fretboard. Comment SAUCE for the link."
    },
    {
      ...
      caption:
        "Ionian diatonic arpeggio practice helps connect the harmony and the fretboard. Learn the shapes, hear the movement, and turn it into music. Comment SAUCE for the link."
    },
    {
      ...
      caption:
        "Cycle 4 workout runs all major scales in-position for technique, key awareness, and fretboard control. Comment SAUCE for the link."
    },
    {
      ...
      caption:
        "Devil's Interval Licks use the b5, tritone tension, and diminished movement to add edge to your blues phrasing. Comment SAUCE for the link."
    }
  ];
}
