...
const TARGET_DAY = { year: 2026, month: 5, day: 9 };

const ASSETS = {
  intervals: "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/Intervals and hs copy.jpg",
  ionianMajorPentatonic: "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/Ionian Major Pentatonic copy.jpg",
  kataKumoiPentatonic: "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/Kumoi Pentatonic copy.jpg",
  linearProgressions: "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/Liear progressions REDO copy.jpg",
  lineCliche: "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/line cliche chords copy.jpg"
};
...
function buildPosts() {
  return [
    ...
    {
      name: "Ionian + Major Pentatonic Cheat Sheet",
      requestedTime: "12:05 PM",
      scheduledDate: parseTimeLabel("12:05 PM"),
      images: [ASSETS.ionianMajorPentatonic],
      caption:
        "Ionian and major pentatonic connect fast once you see which notes come out of the major scale. A simple way to turn one sound into another without getting lost. Comment SAUCE for the link."
    },
    {
      name: "Kata-Kumoi Pentatonic",
      requestedTime: "12:50 PM",
      scheduledDate: parseTimeLabel("12:50 PM"),
      images: [ASSETS.kataKumoiPentatonic],
      caption:
        "Kata-Kumoi pentatonic is a great sound if you want something more exotic without getting lost in too many notes. Strong color, simple layout, useful licks. Comment SAUCE for the link."
    },
    {
      name: "Linear Progressions",
      requestedTime: "8:00 PM",
      scheduledDate: parseTimeLabel("8:00 PM"),
      images: [ASSETS.linearProgressions, ASSETS.lineCliche],
      caption:
        "Linear progressions and line cliche movement are a strong way to hear chords connect through small voice-leading changes. Good harmony study and good guitar vocabulary. Comment SAUCE for the link."
    }
  ];
}
