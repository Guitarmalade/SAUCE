...
const IMAGE_PATH = "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/Numbers In Music copy.jpg";
const CAPTION =
  "Numbers in music start to make more sense when you can see what each number is doing. This cheat sheet breaks down intervals, scale degrees, and Roman numerals so the theory stops feeling scattered. Comment SAUCE for the link.";
