  ...
  return [
    {
      ...
      caption: `Backyard blues starts here.\n\nThese 5 runs will give you fresh ideas before the grill gets hot.\n\nComment BBQ for more.`
    },
    {
      ...
      caption: `Great blues playing is not just about the notes, it is about where you land.\n\nThis phrasing lesson will make your licks sound more musical fast.\n\nComment BBQ for more.`
    },
    {
      ...
      caption: `If your endings feel flat, these turnaround licks in A will clean them up and add some sauce.\n\nComment BBQ for more.`
    },
    {
      ...
      caption: `After the cookout, plug in and work these 12 bar blues fills into your next jam.\n\nComment BBQ for more.`
    }
  ];
}
    ...
    functionExpression((needle) => {
      ...
      return [...document.querySelectorAll("button, [role='button']")].some((element) => {
        ...
        const disabled =
          ...
          element.getAttribute("aria-disabled") === "true" ||
          element.closest("[aria-disabled='true']") !== null;
        return rect.width > 0 && rect.height > 0 && !disabled && text.includes(needle);
      });
    }, "Create post"),
    30_000,
    500
