...
const TODAY = { year: 2026, month: 5, day: 8 };

const ASSETS = {
  chordSpelling: "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/Chord Spelling Cheat Sheet copy.jpg",
  ionianDiatonicArpeggios:
    "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/Diatonic Arpeggio Exercises/Modes/Ionian Diatonic Arpeggios.jpg",
  cycleFourWorkout: "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/cycle 4 aropeggio workout copy.jpg",
  devilsInterval: "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/Devils interval copy.jpg"
};
...
function buildPosts() {
  ...
  const lateAfternoon = parseTimeLabel("5:30 PM");
  const evening = parseTimeLabel("8:00 PM");

  return [
    {
      name: "Chord Spelling Cheat Sheet",
      requestedTime: "12:05 PM",
      scheduledDate: middayOne,
      images: [ASSETS.chordSpelling],
      caption: `Chord spelling is where theory starts making sense.\n\nLearn how chords are built so you can hear it, see it, and use it on the fretboard.\n\nComment SAUCE for the link.`
    },
    {
      name: "Ionian Diatonic Arpeggio Practice",
      requestedTime: "12:50 PM",
      scheduledDate: middayTwo,
      images: [ASSETS.ionianDiatonicArpeggios],
      caption: `Ionian diatonic arpeggio practice is a solid way to connect the harmony and the fretboard.\n\nLearn the shapes, hear the movement, and turn it into music.\n\nComment SAUCE for the link.`
    },
    {
      name: "Cycle 4 Workout",
      requestedTime: "5:30 PM",
      scheduledDate: lateAfternoon,
      images: [ASSETS.cycleFourWorkout],
      caption: `Cycle 4 workout runs all major scales in-position so you can build cleaner technique and stronger key awareness at the same time.\n\nA good one for fretboard control and consistency.\n\nComment SAUCE for the link.`
    },
    {
      name: "Devil's Interval Licks",
      requestedTime: "8:00 PM",
      scheduledDate: evening,
      images: [ASSETS.devilsInterval],
      caption: `Devil's Interval Licks lean into the b5, tritone tension, and diminished movement to push your blues phrasing outside the usual box.\n\nA good one if you want meaner lead sounds and more edge.\n\nComment SAUCE for the link.`
    }
  ];
}
