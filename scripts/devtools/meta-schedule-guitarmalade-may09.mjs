...
const TODAY = { year: 2026, month: 5, day: 9 };
...
function buildPosts() {
  return [
    ...
    },
    {
      ...
      caption: `Ionian and major pentatonic connect fast once you see which notes come out of the major scale.\n\nA simple way to turn one sound into another without getting lost.\n\nComment SAUCE for the link.`
    },
    {
      ...
      caption: `Kata-Kumoi pentatonic is a great sound if you want something more exotic without getting lost in too many notes.\n\nStrong color, simple layout, useful licks.\n\nComment SAUCE for the link.`
    },
    {
      ...
      caption: `Linear progressions and line cliche movement are a strong way to hear chords connect through small voice-leading changes.\n\nGood harmony study and good guitar vocabulary.\n\nComment SAUCE for the link.`
    }
  ];
}
