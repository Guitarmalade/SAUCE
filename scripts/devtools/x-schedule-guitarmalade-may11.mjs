...
const TARGET_DAY = { year: 2026, month: 5, day: 11 };

const ASSETS = {
  topFiveBluesRuns: "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/Guitarmalade Blues Bible/blues run top 5 copy.jpg",
  bluesGuitarPhrasing: "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/Guitarmalade Blues Bible/Building blues licks.jpg",
  bluesTurnaroundLicksInA:
    "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/Guitarmalade Blues Bible/blues turnaround licks copy.jpg",
  twelveBarBluesAndFills: "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/Guitarmalade Blues Bible/blues w fills A.jpg"
};
...
function buildPosts() {
  return [
    {
      name: "Top 5 Blues Runs",
      requestedTime: "10:07 AM",
      scheduledDate: parseTimeLabel("10:07 AM"),
      images: [ASSETS.topFiveBluesRuns],
      caption:
        "Backyard blues starts here. These 5 runs will give you fresh ideas before the grill gets hot. Comment BBQ for more."
    },
    {
      name: "Blues Guitar Phrasing - 101",
      requestedTime: "12:05 PM",
      scheduledDate: parseTimeLabel("12:05 PM"),
      images: [ASSETS.bluesGuitarPhrasing],
      caption:
        "Great blues playing is not just about the notes, it is about where you land. This phrasing lesson will make your licks sound more musical fast. Comment BBQ for more."
    },
    {
      name: "Blues Turnaround Licks in A",
      requestedTime: "12:50 PM",
      scheduledDate: parseTimeLabel("12:50 PM"),
      images: [ASSETS.bluesTurnaroundLicksInA],
      caption:
        "If your endings feel flat, these turnaround licks in A will clean them up and add some sauce. Comment BBQ for more."
    },
    {
      name: "12 Bar Blues & Fills",
      requestedTime: "8:00 PM",
      scheduledDate: parseTimeLabel("8:00 PM"),
      images: [ASSETS.twelveBarBluesAndFills],
      caption:
        "After the cookout, plug in and work these 12 bar blues fills into your next jam. Comment BBQ for more."
    }
  ];
}
