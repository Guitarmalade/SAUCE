...
const ASSETS = {
  suspendedTriads: "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/Sus triads copy.jpg",
  chordsComeFrom: "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/Where DO Chords COme From.jpg",
  sweepArpeggios: "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/Charlie Sweep Arpeggios copy.jpg",
  slashChordsPage1: "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/slash chords cheat sheet copy.jpg",
  slashChordsPage2: "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/slash chords 2 copy.jpg",
  slashChordsPage3: "/Users/chrisschreiner/Desktop/Guitarmalade Warmups/slash chords 3 export.jpg"
};
...
function buildPosts() {
  ...
  return [
    {
      name: "Suspended Triads",
      requestedTime: "8:00 AM",
      scheduledDate: morning,
      images: [ASSETS.suspendedTriads],
      caption: `If your chords sound flat, sus2 and sus4 shapes are one of the fastest ways to add movement without learning a whole new system.\n\nThis cheat sheet helps you see and use suspended triads across and along the strings so your rhythm playing sounds more intentional right away.\n\nQuick win, strong sound, easy to use in real songs.\n\nComment SAUCE for the link.\n\n#guitarlesson #guitarchords #triads #guitarpractice #rhythmguitar`
    },
    {
      name: "Where Do Chords Come From?",
      requestedTime: "12:05 PM",
      scheduledDate: middayOne,
      images: [ASSETS.chordsComeFrom],
      caption: `If music theory feels random, this is the missing link.\n\nSee how chords are pulled straight out of the scale so chord progressions, arpeggios, and solo choices start making sense together instead of feeling like separate topics.\n\nThis is the kind of page that clears up a lot fast.\n\nComment SAUCE for the link.\n\n#guitarlesson #musictheory #guitarchords #triads #guitarpractice`
    },
    {
      name: "How to Practice Sweep Arpeggios",
      requestedTime: "12:50 PM",
      scheduledDate: middayTwo,
      images: [ASSETS.sweepArpeggios],
      caption: `If you know sweep shapes but never know what to actually practice, use this page.\n\nIt gives you a step-by-step path from slow picking pattern work to playing in time and building speed without turning practice into chaos.\n\nWay better than just blasting through shapes and hoping they clean up later.\n\nComment SAUCE for the link.\n\n#guitarlesson #sweeppicking #arpeggios #leadguitar #guitarpractice`
    },
    {
      name: "Slash Chords Cheat Sheet",
      requestedTime: "8:00 PM",
      scheduledDate: evening,
      images: [ASSETS.slashChordsPage1, ASSETS.slashChordsPage2, ASSETS.slashChordsPage3],
      caption: `If your chord progressions feel stuck, slash chords are a simple way to create movement in the bass and make the same harmony sound way more musical.\n\nThis 3-page cheat sheet shows inversions, hybrid chords, and real examples you can drop into songs today.\n\nPerfect if you want richer rhythm parts without overcomplicating things.\n\nComment SAUCE for the link.\n\n#guitarlesson #guitarchords #songwriting #musictheory #guitarpractice`
    }
  ];
}
